    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <FlowBooksLogo size={48} className="mx-auto mb-4" />
          <h1 className="font-serif text-2xl font-semibold">Create your account</h1>
          <p className="text-sm text-muted-foreground mt-1">Start managing your freelance finances</p>
        </div>
        ...
        <form onSubmit={handleSubmit(handleSignup)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input id="name" placeholder="Jane Doe" {...register("fullName")} />
            {errors.fullName && (
